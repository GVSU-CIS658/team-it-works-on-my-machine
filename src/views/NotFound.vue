<template>
  <div class="not-found-view">
    <div>
      ...
      <p>
        The route may have moved, the link may be outdated, or the address may
        never have existed in this application.
      </p>
      <div>
...
<style scoped lang="sass" src="../styles/pages/not-found.sass"></style>
